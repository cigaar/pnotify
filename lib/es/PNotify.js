/* src/PNotify.html generated by Svelte v2.0.0 */
...
function create_main_fragment(component, state) {
	var div, div_1, each_blocks_1 = [], each_lookup = blankObject(), text, text_1, text_2, text_3, each_1_blocks_1 = [], each_1_lookup = blankObject(), div_1_class_value, div_1_style_value, div_class_value;

	var each_value = state._modulesPrependContainer;

	for (var i = 0; i < each_value.length; i += 1) {
		var key = each_value[i].key;
		each_blocks_1[i] = each_lookup[key] = create_each_block(component, key, assign(assign({}, state), {
	...
	var if_block = (state.icon !== false) && create_if_block(component, state);

	var if_block_1 = (state.title !== false) && create_if_block_1(component, state);

	var if_block_2 = (state.text !== false) && create_if_block_4(component, state);

	var each_value_1 = state._modulesAppendContainer;

	for (var i = 0; i < each_value_1.length; i += 1) {
		var key_1 = each_value_1[i].key;
		each_1_blocks_1[i] = each_1_lookup[key_1] = create_each_block_1(component, key_1, assign(assign({}, state), {
			each_value_1: each_value_1,
			module: each_value_1[i],
			module_index_1: i
		}));
	}
	...
	return {
		...
		h: function hydrate() {
			...
			div_1.style.cssText = div_1_style_value = "" + state._widthStyle + " " + state._minHeightStyle;
		...
		m: function mount(target, anchor) {
			...
			for (i = 0; i < each_1_blocks_1.length; i += 1) each_1_blocks_1[i].m(div_1, null);
		...
		p: function update(changed, state) {
			...
			each_blocks_1 = updateKeyedEach(each_blocks_1, component, changed, "key", 0, each_value, each_lookup, div_1, false, create_each_block, "m", text, function(i) {
			...
			each_1_blocks_1 = updateKeyedEach(each_1_blocks_1, component, changed, "key", 0, each_value_1, each_1_lookup, div_1, false, create_each_block_1, "m", null, function(i) {
				return assign(assign({}, state), {
					each_value_1: each_value_1,
					module: each_value_1[i],
					module_index_1: i
			...
			if ((changed._widthStyle || changed._minHeightStyle) && div_1_style_value !== (div_1_style_value = "" + state._widthStyle + " " + state._minHeightStyle)) {
...
function create_each_block(component, key_1, state) {
	var module = state.module, each_value = state.each_value, module_index = state.module_index;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (switch_value !== (switch_value = module)) {
...
function create_if_block_1(component, state) {
	...
	function select_block_type(state) {
		if (state.titleTrusted) return create_if_block_2;
...
function create_if_block_4(component, state) {
	...
	function select_block_type_1(state) {
		if (state.textTrusted) return create_if_block_5;
	...
	return {
		...
		h: function hydrate() {
			div.className = div_class_value = "ui-pnotify-text " + (state._styles.text ? state._styles.text : '');
		...
		p: function update(changed, state) {
			...
			if ((changed._styles) && div_class_value !== (div_class_value = "ui-pnotify-text " + (state._styles.text ? state._styles.text : ''))) {
				div.className = div_class_value;
			}
		},
...
function create_each_block_1(component, key_1, state) {
	var module = state.module, each_value_1 = state.each_value_1, module_index_1 = state.module_index_1;
	var first, switch_instance_anchor;
	...
	return {
		...
		p: function update(changed, state) {
			...
			module_index_1 = state.module_index_1;
			if (switch_value !== (switch_value = module)) {
				if (switch_instance) switch_instance.destroy();
...
function PNotify_1(options) {
	...
	var _oncreate = function() {
		var changed = { styling: 1, icons: 1, width: 1, minHeight: 1, icon: 1, _styles: 1, addClass: 1, _animatingClass: 1, _moveClass: 1, animation: 1, animateSpeed: 1, stack: 1, _moduleClasses: 1, type: 1, cornerClass: 1, shadow: 1, _widthStyle: 1, _minHeightStyle: 1, _modulesPrependContainer: 1, _icons: 1, title: 1, titleTrusted: 1, text: 1, textTrusted: 1, _modulesAppendContainer: 1 };
		oncreate.call(self);
