/* src/PNotify.html generated by Svelte v1.60.2 */
...
function create_main_fragment(component, state) {
	var div, div_1, text, text_1, text_2, text_3, div_1_class_value, div_1_style_value, div_class_value;
	...
	return {
		...
		p: function update(changed, state) {
			...
			if (changed._modulesAppendContainer) {
				for (var i = each_1_blocks.length; i < each_value_1.length; i += 1) {
...
// (82:4) {{#each _modulesAppendContainer as module}}
...
assign(assign(PNotify_1.prototype, methods), {
 	destroy: destroy,
 	get: get,
 	fire: fire,
 	observe: observe,
