/* src/PNotifyConfirm.html generated by Svelte v2.0.0 */
...
function create_each_block(component, state) {
	var button = state.button, each_value = state.each_value, button_index = state.button_index;
...
function create_if_block_4(component, state) {
	var button = state.button, each_value = state.each_value, button_index = state.button_index;
	var raw_value = button.text, raw_before, raw_after;
...
function create_if_block_5(component, state) {
	var button = state.button, each_value = state.each_value, button_index = state.button_index;
	var text_value = button.text, text;
...
function click_handler(event) {
	...
	var each_value = this._svelte.each_value, button_index = this._svelte.button_index, button = each_value[button_index];
