...
/* src/PNotifyDesktop.html generated by Svelte v2.0.0 */
    ...
    initModule: function initModule(options) {
      ...
      _notice.on('state', function (_ref) {
        ...
        if (changed.animation) {
          if (previous.animation === undefined || current.animation !== 'none' || previous.animation === 'none' && current.animation !== _this2.get()._oldAnimation) {
            _this2.set({ '_oldAnimation': current.animation });
          }
        }
        ...
        if (changed._animatingClass) {
          if (!(current._animatingClass === '' || permission !== 0 && _this2.get().fallback || !_this2.get().desktop)) {
