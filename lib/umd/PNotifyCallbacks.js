(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define('PNotifyCallbacks', ['exports', "PNotify"], factory);
		...
		global.PNotifyCallbacks = mod.exports;
	}
	...
	var _open = _PNotify2.default.prototype.open;
	var _close = _PNotify2.default.prototype.close;
	...
	_PNotify2.default.prototype.open = function () {
	...
	_PNotify2.default.prototype.close = function (timerHide) {
	...
	function setup(Component) {
		...
		var _alert = _PNotify2.default.alert;
		var _notice = _PNotify2.default.notice;
		var _info = _PNotify2.default.info;
		var _success = _PNotify2.default.success;
		var _error = _PNotify2.default.error;
		...
		_PNotify2.default.alert = function (options) {
			return init(_alert, options);
		};
		_PNotify2.default.notice = function (options) {
			return init(_notice, options);
		};
		_PNotify2.default.info = function (options) {
			return init(_info, options);
		};
		_PNotify2.default.success = function (options) {
			return init(_success, options);
		};
		_PNotify2.default.error = function (options) {
			return init(_error, options);
		};

		// Register the module with PNotify.
		_PNotify2.default.modules.Callbacks = Component;
	};
	...
	exports.default = PNotifyCallbacks;
});