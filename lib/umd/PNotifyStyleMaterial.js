(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define("PNotifyStyleMaterial", ["exports", "PNotify"], factory);
	...
	function setup(Component) {
		...
		_PNotify2.default.styling.material = _extends(_PNotify2.default.styling.material, {
		...
		_PNotify2.default.icons.material = _extends(_PNotify2.default.icons.material, {
	...
	function PNotifyStyleMaterial(options) {
		...
		if (!document.getElementById("svelte-1192254407-style")) add_css();
